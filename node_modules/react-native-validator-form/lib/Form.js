...
_this.childs=[];return _this;
}_createClass(Form,[{key:'getChildContext',value:function getChildContext()
...
}},{key:'getValidator',value:function getValidator(

validator,value,includeRequired){
var result=true;
var name=validator;
...
return result;
}},{key:'attachToForm',value:function attachToForm(

component){
if(this.childs.indexOf(component)===-1){
this.childs.push(component);
}
}},{key:'detachFromForm',value:function detachFromForm(
...
return result;
}},{key:'checkInput',value:function checkInput(
...
input,includeRequired){var _this2=this;
var value=input.props.value;
var validators=input.props.validators;
var result=[];
var valid=true;
var validateResult=false;
var component=this.find(this.childs,function(component){return component.props.name===input.props.name;});
...
this.props,onSubmit=_props.onSubmit,instantValidate=_props.instantValidate,onError=_props.onError,rest=_objectWithoutProperties(_props,['onSubmit','instantValidate','onError']);
return(
_react2.default.createElement(_reactNative.View,rest,
this.props.children));


}}]);return Form;}(_react2.default.Component);


Form.addValidationRule=function(name,callback){
...
Form.defaultProps={
onError:function onError(){}};exports.default=
